<?php
    ...
    if ( ! class_exists( 'ReduxFrameworkPlugin' ) ) {
        ...
        class ReduxFrameworkPlugin {
             ...
             * @since       3.0.0
             */
            protected $plugin_slug = 'property-assessment';
            ...
            public function includes() {
                ...
                if ( $this->options['demo'] && file_exists( dirname( __FILE__ ) . '/assessment/assessment-config.php' ) ) {
                    require_once dirname( __FILE__ ) . '/assessment/assessment-config.php';
                }
            }
            ...
            public function plugin_metalinks( $links, $file ) {
                if ( strpos( $file, 'wp-instant-cma.php' ) !== false && is_plugin_active( $file ) ) {
                    ...
                    if ( ( is_multisite() && $this->plugin_network_activated ) || ! is_network_admin() || ! is_multisite() ) {
                        if ( $this->options['demo'] ) {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . __( 'Hide Menu Now', 'redux-framework' ) . '</a></span>';
                        } else {
                            $new_links[3] .= '<br /><span style="display: block; padding-top: 6px;"><a href="./plugins.php?ReduxFrameworkPlugin=demo" style="color: #bc0b0b;">' . __( 'Show Menu Now', 'redux-framework' ) . '</a></span>';
                        }
                    }
